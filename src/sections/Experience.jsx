const experience = [
    {
        ...
        description: "Leading Frontend architecture fpor a business products",
        tecnologies: ["React", "Typescript", "NextJS", "GraphQL"],
        currnet: false
    },
             ...
             <div className="container mx-auto px-6 relative z-10">
                {/* Section Header */}
                  <div className="max-w-3xl mb-16">
                    ...
                    > Experience that <span className="italic font-normal font-serif text-white"> {" "}Speaks volumes</span></h2>
                  ...
                  <div className="relative">
                    <div className="timeline-glow absolute left-0  md:left-1/2 top-0 bottom-0
                     ...
                     md: -translate-x-1/2 shadow-[0_0_25px_rgba(38,178,166,0.8)]"/>

                    {/* Experience Items */}
                    <div className="space-y-12">
                        {experience.map((exp, idx) => (
                            <div className="relative grid md:grid-cols-2 gap-8 animate-fade-in style={{ animationDelay: `$((idx + 1) * 130)ms`}}" key={idx}>

                                {/* TimeLine Dot */}
 
                                <div className="absolute left-0 md:left-1/2 top-0 md:left-1/2 top-0 w-3 h-3 rounded-full bg-primary rounded-full  -translate-x-1/2 ring-4-background z-10">
                                {exp.currnet && (<span className=" absolute inset-0 rounded-full bg-primary animate-pulse"/>)}
                                </div>
                                ...
                                <div className={`pl-8 md:pl-0 ${idx % 2 ===0 ? "md:pr-16 md:text-right" : "md:col-start-2 md-pl-16"}`}>
                                    <div className={`glass p-6 rounded-2xl border border-primary/30 hover:border-primary/50 transition-all duration-500"}`}>
                                        ...
                                        <div>{exp.tecnologies.map((tech, techIdx) =>(
